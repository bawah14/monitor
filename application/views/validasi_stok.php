  			...
  			<div class="col-lg-12">
		  		<div class="x_panel">
  					<div class="x_tittle">
						<div class="row">
							<div class="col-lg-8">
								<h2>Daftar Stok Tanggal</h2>
							</div>
						</div>
						<div class="row">
				            <?php echo form_open(base_url('index.php/router/validasi_stok'),array('name'=>'inputharga', 'method'=>'POST')); ?>
							<?php //echo form_open() ?>
					    	<div class="col-lg-4"> 
					    	...
					    	<div class="col-lg-1">
					    		<!-- <div class="form-group"> -->
					    			<a href="<?php echo base_url('index.php/router/handlervalidasi/stok') ?>">
						    			<button class="btn btn-info">Validasi</button>
					    			</a>
					    		<!-- </div> -->
					    	</div>
					    	<div class="col-lg-1">
					    		<button class="btn btn-success" id="export-xls-stok">export</button>
					    	</div>
					    </div>
